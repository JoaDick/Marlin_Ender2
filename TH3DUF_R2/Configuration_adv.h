...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH           20 //  2 
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     50 // 20  
  #define FILAMENT_CHANGE_UNLOAD_ACCEL       100 // 25  
  ...
  #else
    #define FILAMENT_CHANGE_UNLOAD_LENGTH      340 // 100
  #endif
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    25 //    0  
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  50 //   20  
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     15 //   25  
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   300 //    0  
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  
  #define ADVANCED_PAUSE_PURGE_LENGTH         15 //   50  
  #define FILAMENT_UNLOAD_RETRACT_LENGTH       0 //   13 
  #define FILAMENT_UNLOAD_DELAY             1000 // 2000 
  #define FILAMENT_UNLOAD_PURGE_LENGTH         0 //    8 
  #define PAUSE_PARK_NOZZLE_TIMEOUT           60 
  #define FILAMENT_CHANGE_ALERT_BEEPS          5 //   10 
